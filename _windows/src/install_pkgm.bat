...
pnpm add -g @innocenzi/rename @vivliostyle/cli ascii-silhouettify commitizen degit echo-cli ki-cli ki-cli-hyphen npms-cli markserv open-cli png-to-ico retypeapp serve tldr ttf2woff2 vercel webtorrent-mpv-hook repomix
:: carbon-now
pnpm add -g clean-css html-minifier js-beautify prettier svgo terser

pipx install ass2srt coloro doc2dash ffsubsync gethash hererocks pip_search subliminal vtt_to_srt3 wappalyzer yoga "rembg[cli]"
...
:: git clone https://github.com/matt-bartel/gh-clone-org C:\Users\User\AppData\Local\GitHub CLI\extensions gh-clone-org
