...
mklink "%SUBLIMETEXT_DATA%\Packages\User\LanguageTool.sublime-settings" "%SUBLIMETEXT_DOTFILE%\Packages_User\LanguageTool.sublime-settings"
rem mklink "%SUBLIMETEXT_DATA%\Packages\User\JsPrettier.sublime-settings" "%SUBLIMETEXT_DOTFILE%\Packages_User\JsPrettier.sublime-settings"
rem mklink "%SUBLIMETEXT_DATA%\Packages\User\LSP.sublime-settings" "%SUBLIMETEXT_DOTFILE%\Packages_User\LSP.sublime-settings"
...
rem mklink "%SUBLIMETEXT_DATA%\Packages\User\Minify.sublime-settings" "%SUBLIMETEXT_DOTFILE%\Packages_User\Minify.sublime-settings"
