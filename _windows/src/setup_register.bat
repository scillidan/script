...
gsudo C:\Users\User\Scoop\apps\lockhunter\current\install-context.reg
gsudo C:\Users\User\Scoop\apps\losslesscut\current\install-associations.reg
gsudo C:\Users\User\Scoop\apps\obs-studio\current\data\obs-plugins\win-dshow\virtualcam-install.bat
